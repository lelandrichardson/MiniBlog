...
namespace MiniBlog.Includes.Data
{
    ...
    public static partial class SqlMapper
    {
        ...
        ///// <summary>
        ///// Execute parameterized SQL, with the ability to use output params.
        ///// </summary>
        ///// <param name="param">object of parameters.  fields starting with "__" will be 
        ///// defaulted to output params.  The output values are fed back into the object.</param>
        ///// <returns>number of rows affected</returns>
        ...
        //    var i = cnn.Execute(sql, p, null, null, commandType);
        //    dynamic objOut = new FastExpando();
        //    foreach (var output in p.OutputParameters)
        //    {
        //        objOut[output.Name] =
        //    }
        //    param = p;
...
#else
this IDbConnection cnn, string sql, dynamic param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure
#endif
)
        {
...
#else
this IDbConnection cnn, string sql, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure
#endif
)
        {
...
#else
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TReturn> map, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure
#endif
)
        {
...
#else
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TReturn> map, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure
#endif
)
        {
...
#else
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure
#endif
)
        {
        ...
        private static int ExecuteCommand(IDbConnection cnn, IDbTransaction transaction, string sql, Action<IDbCommand, object> paramReader, object obj, int? commandTimeout, CommandType? commandType = CommandType.StoredProcedure)
        {
...
)
        {
            ...
            var setters = (
                            ...
                            let prop = properties.FirstOrDefault(p => string.Equals(p.Name, n, StringComparison.Ordinal)) // property case sensitive first
                                  ...
                                  ?? properties.FirstOrDefault(p => string.Equals(p.Name, n.Replace("_", ""), StringComparison.OrdinalIgnoreCase)) // property case insensitive without "_" third
                            let field = prop != null ? null : (fields.FirstOrDefault(p => string.Equals(p.Name, n, StringComparison.Ordinal)) // field case sensitive fourth
                                ...
                                ?? fields.FirstOrDefault(p => string.Equals(p.Name, n.Replace("_", ""), StringComparison.OrdinalIgnoreCase))) // field case insensitive without "_" sixth
